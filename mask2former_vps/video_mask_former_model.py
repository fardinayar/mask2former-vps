...
class VideoMaskFormer_frame(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            for mask_pred_result, input_per_image, image_size in zip(
                mask_pred_results.permute(1,0,2,3), batched_inputs[0], images.image_sizes
            ):
                height = image_size[0]
                width = image_size[1]
                ...
                if self.sem_seg_postprocess_before_inference:
                    ...
                    panoptic_r = retry_if_cuda_oom(self.inference_video)(mask_cls_result, mask_pred_result)
    ...
    def inference_video(self, mask_cls, mask_pred):
